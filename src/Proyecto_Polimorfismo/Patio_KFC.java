...
public class Patio_KFC extends Patio {
    ...
    public int getPedido() {
        ...
        switch (pedido) {
            ...
            case 2:
                ...
                total = (3.50 * getNum()) + iva;
                precioComida = (total - iva) / num;
                break;
            case 3:
                
                total = (3.75 * getNum()) + iva;
                precioComida = (total - iva) / num;
                break;
            case 4:
    ...
    public String toString() {
        ...
        return ("\n\t///////////////////////////////////////////////////////////\n"
                ...
                + "OPCION: 1\n"
                + "///////////////////////////////////////////////////////\n"
                + "USTED HA ESCOGIDO KFC\n"
                + "A CONTINUACION ESCOJA SU PEDIDO DEL SIGUIENTE MENU\n"
                + "1. COMBO 1 (ARROZ, ALITAS, MENESTRA Y COLA)---> $3.00\n"
                + "2. COMBO 2 (ARROZ, ALITAS, MENESTRA, PAPAS Y COLA)---> $3.50\n"
                + "3. COMBO 3 (6 ALITAS PICANTES, PAPAS Y COLA)---> $3.75\n"
                + "4. COMBO 4 (12 ALITAS PICANTES, PAPAS Y COLA)---> $7.00\n"
                + "5. COMBO 5 (ARROZ, ALITAS, MENESTRA, PAPAS, ENSALADA Y COLA)---> $5.00\n"
                + "OPCION: " + getPedido() + "\n"
