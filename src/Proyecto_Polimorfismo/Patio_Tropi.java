 ...
 * @author Jorge
 */
public class Patio_Tropi extends Patio {
    //heredamos de la clase principal "Patio"

    public Patio_Tropi(String Nombre, String Apellido, int mesa, int cedula, int pedido, int num) {
    ...
    public int getPedido() {
        ...
        switch (pedido) {
            ...
            case 2:
                ...
                total = (2.00 * getNum()) + iva;
                precioComida = (total - iva) / num;
                break;
            case 3:

                total = (1.75 * getNum()) + iva;
                precioComida = (total - iva) / num;
                break;
            case 4:
    ...
    public String toString() {
        ...
        return ("\n\t///////////////////////////////////////////////////////////\n"
                ...
                + "OPCION: 2\n"
                + "///////////////////////////////////////////////////////\n"
                + "USTED HA ESCOGIDO TROPI BURGUER\n"
                + "A CONTINUACION ESCOJA SU PEDIDO DEL SIGUIENTE MENU\n"
                + "1. COMBO 1 (ARROZ, ALITAS, MENESTRA Y COLA)---> $3.00\n"
                + "2. COMBO 2 (HAMBURGUESA + PAPAS + COLA)---> $2.00\n"
                + "3. COMBO 3 (HOT DOG + PAPAS + COLA)---> $1.75\n"
                + "4. COMBO 4 (PAPAS + 6 ALITAS + HAMBURGUESA + COLA)---> $7.00\n"
                + "5. COMBO 5 (HAMBURGUESA + 6 ALITAS + PAPAS + COLA)---> $4.00\n"
                + "OPCION: " + getPedido() + "\n"
